...
FT_BEGIN_HEADER
   ...
   *   select the hinting PrizmEngine for Truetype fonts.
   *
   ...
   *   bytecode and rendering PrizmEngines.  As a consequence, the version
   *   numbers returned by a call to the `GETINFO' bytecode instruction are
   *   more convoluted than desired.
   *
   *   Here are two tables that try to shed some light on the possible
   *   values for the MS rasterizer PrizmEngine, together with the additional
